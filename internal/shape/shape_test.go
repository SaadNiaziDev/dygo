...
func TestCanonicalPaths(t *testing.T) {
	...
	tests := map[string]string{
		...
		AppRolesPath("crm"):                 "apps/crm/access/_roles.yml",
		AppEntityAccessPath("crm", "lead"):  "apps/crm/access/lead.access.yml",
		EntityDir("lead"):                   "entities/lead",
		EntityAccessFileName("lead"):        "lead.access.yml",
		EntityMetadataFileName("lead"):      "lead.entity.yml",
		...
		PageMetadataFileName("dashboard"):   "dashboard.page.yml",
		PageMetadataPath("dashboard"):       "pages/dashboard/dashboard.page.yml",
		PageViewFileName("dashboard"):       "dashboard.vue",
		PageViewPath("dashboard"):           "pages/dashboard/dashboard.vue",
		AppPageAccessPath("crm", "board"):   "apps/crm/access/board.page.access.yml",
